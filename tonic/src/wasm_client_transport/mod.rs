...
//! provides builders to configure wasm_client_transport behavior.
//!
//! # Features
//!
...
//!
//! ```no_run
//! # use tonic::wasm_client_transport::{Channel, Certificate, ClientTlsConfig};
...
//!
//! ```no_run
//! # use tonic::wasm_client_transport::{Server, Identity, ServerTlsConfig};
...
//! #   }
//! # }
//! # impl tonic::wasm_client_transport::NamedService for Svc {
