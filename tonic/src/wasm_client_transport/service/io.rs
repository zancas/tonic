use crate::wasm_client_transport::{server::Connected, Certificate};
...
pub(in crate::wasm_client_transport) trait Io:
...
impl BoxedIo {
    pub(in crate::wasm_client_transport) fn new<I: Io>(io: I) -> Self {
        BoxedIo(Box::pin(io))
    }
}
...
pub(in crate::wasm_client_transport) trait ConnectedIo: Io + Connected {}
...
impl ServerIo {
    pub(in crate::wasm_client_transport) fn new<I: ConnectedIo>(io: I) -> Self {
        ServerIo(Box::pin(io))
    }
}
