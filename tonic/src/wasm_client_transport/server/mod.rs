...
#[cfg(feature = "tls")]
use crate::wasm_client_transport::Error;

use super::service::{Or, Routes, ServerIo, ServiceBuilderExt};
use crate::wasm_client_transport::proxy::{ProxyConfig, ProxySvc};
...
/// A default batteries included `wasm_client_transport` server.
///
...
impl Server {
    ...
    ///
    /// ```
    /// # use tonic::wasm_client_transport::Server;
